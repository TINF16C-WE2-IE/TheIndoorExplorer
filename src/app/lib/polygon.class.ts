...
export class Polygon {
    ...
    public union(other: Polygon): Polygon[] {
        ...
        let intersectionPoints: {p: Point, dist: number, ref: VertexRef}[] = [];
        ...
        do {
            ...
            do {
                ...
                intersection = this.linesIntersection(l1, l2, false);
            ...
            if (nearest.p !== null) {
                ...
                // to be able to split it there.

                const ref1 = new VertexRef(nearest.p, v1.next, v1);
                v1.next.previous = ref1;
                v1.next = ref1;
                const ref2 = new VertexRef(nearest.p, nearest.ref.next, nearest.ref);
                nearest.ref.next.previous = ref2;
                nearest.ref.next = ref2;
                ref1.data = ref2; // save neighbour data
                ref2.data = ref1;
                is_entry = !is_entry;
